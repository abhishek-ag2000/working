    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Company_employee', to='company.Organisation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_code', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to='qr_images')),
                ('is_qr', models.BooleanField(default=False)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Company_stock_master', to='company.Organisation')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
