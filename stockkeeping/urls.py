...
################################### Stockdata Monthly Url ######################################
    ...
    url(r'^company/(?P<pk>\d+)/stockrdatewise/(?P<month>\d+)/(?P<pk2>\d+)/date/(?P<pk3>\d+)/$',views.stock_summary_datewise,name='stockdatewise'),
...
################################### Purchase Url #######################################
	...
	url(r'^company/(?P<pk>\d+)/purchasedatewise/(?P<month>\d+)/date/(?P<pk3>\d+)/$',views.purchase_register_datewise,name='purchase_datewise'),
