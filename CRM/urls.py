...
from .views_leads import LeadListView,CreateLeadView,UpdateLeadView,DetailLeadView
...
# ############################################### CRM Urls ###############################################
    ...
    url(r'^company/(?P<organisation_pk>\d+)/crm_leads/$', LeadListView.as_view(), name='crm_leads'),
    url(r'^company/(?P<organisation_pk>\d+)/crm_lead_create/$', CreateLeadView.as_view(), name='crm_lead_create'),
    url(r'^company/(?P<organisation_pk>\d+)/crm_lead_update/(?P<lead_pk>\d+)/$', UpdateLeadView.as_view(), name='crm_lead_update'),
    url(r'^company/(?P<organisation_pk>\d+)/crm_lead_detail/(?P<lead_pk>\d+)/$', DetailLeadView.as_view(), name='crm_lead_detail'),
  ]