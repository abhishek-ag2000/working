...
urlpatterns = [
	...
	url(r'^servicelist/$',views.service_list_view.as_view(),name='servicelist'),
	url(r'^specificservicelist/(?P<pk>\d+)/$',views.service_specific_profile,name='specificservicelist'),
	...
	path('roleactivate/<product_activation_id>', views.activate_subscriptions_rolebasedproductlist, name='activate_roleproduct'),
	path('roledeactivate/<product_activation_id>', views.deactivate_subscriptions_rolebasedproductlist, name='deactivate_roleproduct'),
...
############################# Achievements Url ##############################################################
	...
	url(r'^prof/member/search/$', views.search_professionals_members, name='search_prof'),

	url(r'^organisation/member/add/(?P<pk>\d+)/$', views.add_members, name='add_member'),
]