...
from userprofile.models import Profile, Product_activation, Role_product_activation, Post, Post_comment, Pro_services, achivements, pro_verify, Organisation, Organisation_member
...
admin.site.register(Role_product_activation)
