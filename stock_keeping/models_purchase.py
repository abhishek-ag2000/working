...
class PurchaseVoucher(models.Model):
    ...
    nature_transactions_purchase = models.CharField(
        max_length=100, choices=transaction_types, default='Not Applicable')
    ...
    def save(self, **kwargs):
        ...
        if self.stock_item:
            ...
            if self.purchase_voucher.company.gst_registration_type == 'Regular':
                ...
                elif self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
                    if self.purchase_voucher.doc_ledger.central_tax != 0 or self.purchase_voucher.doc_ledger.state_tax != 0:
                        self.cgst = self.purchase_voucher.doc_ledger.central_tax
                        self.sgst = self.purchase_voucher.doc_ledger.state_tax
                        self.igst = 0
                ...
                elif self.purchase_voucher.company.organisation.state == 'Andaman & Nicobar Islands' and self.purchase_voucher.party_ac.state == 'Andaman & Nicobar Islands' and self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
                    if self.purchase_voucher.doc_ledger.central_tax != 0 or self.purchase_voucher.doc_ledger.state_tax != 0:
                        self.cgst = self.purchase_voucher.doc_ledger.central_tax
                        self.sgst = self.purchase_voucher.doc_ledger.state_tax
                        self.igst = 0
                ...
                elif self.purchase_voucher.company.organisation.state == 'Chandigarh' and self.purchase_voucher.party_ac.state == 'Chandigarh' and self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
                    if self.purchase_voucher.doc_ledger.central_tax != 0 or self.purchase_voucher.doc_ledger.state_tax != 0:
                        self.cgst = self.purchase_voucher.doc_ledger.central_tax
                        self.sgst = self.purchase_voucher.doc_ledger.state_tax
                        self.igst = 0
                        ...
                        self.sgst = self.purchase_voucher.company.state_tax
                        self.igst = 0
                elif self.purchase_voucher.company.organisation.state == 'Dadra and Nagar Haveli' and self.purchase_voucher.party_ac.state == 'Dadra and Nagar Haveli' and self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
                    if self.purchase_voucher.doc_ledger.central_tax != 0 or self.purchase_voucher.doc_ledger.state_tax != 0:
                        self.cgst = self.purchase_voucher.doc_ledger.central_tax
                        self.sgst = self.purchase_voucher.doc_ledger.state_tax
                        self.igst = 0
                ...
                elif self.purchase_voucher.company.organisation.state == 'Daman and Diu' and self.purchase_voucher.party_ac.state == 'Daman and Diu' and self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
                    if self.purchase_voucher.doc_ledger.central_tax != 0 or self.purchase_voucher.doc_ledger.state_tax != 0:
                        self.cgst = self.purchase_voucher.doc_ledger.central_tax
                        self.sgst = self.purchase_voucher.doc_ledger.state_tax
                        self.igst = 0
                ...
                elif self.purchase_voucher.company.organisation.state == 'Lakshadweep' and self.purchase_voucher.party_ac.state == 'Lakshadweep' and self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
                    if self.purchase_voucher.doc_ledger.central_tax != 0 or self.purchase_voucher.doc_ledger.state_tax != 0:
                        self.cgst = self.purchase_voucher.doc_ledger.central_tax
                        self.sgst = self.purchase_voucher.doc_ledger.state_tax
                        self.igst = 0
            ...
            if self.purchase_voucher.company.gst_registration_type == 'Regular':
                if self.purchase_voucher.nature_transactions_purchase == 'Intrastate Purchase Deemed Exports - Taxable':
...
class PurchaseTerm(models.Model):
    ...
    ledger = models.ForeignKey(
        LedgerMaster, on_delete=models.CASCADE, related_name='purchase_term_ledger')
