...
urlpatterns = [
    ...
    url(r'^company/(?P<company_pk>\d+)/ajax/validate_stock_name$',
        views_ajax.validate_stock_name, name='validate_stock_name'),

    url(r'^ajax/reg_ledger_value/$', views_ajax.get_registered_ledger_value,
        name='get_registered_ledger_value'),

    url(r'^ajax/reg_stock_value/$', views_ajax.get_exempt_stock_value,
        name='get_exempt_stock_value'),

    url(r'^ajax/nongst_stock_value/$', views_ajax.get_nongst_stock_value,
        name='get_nongst_stock_value'),

    url(r'^ajax/registered_stock_value/$',
        views_ajax.get_taxable_stock_value, name='get_taxable_stock_value'),

    url(r'^ajax/nilrated_stock_value/$', views_ajax.get_nilrated_stock_value,
        name='get_nilrated_stock_value'),

    url(r'^ajax/alteration_gst/$', views_ajax.get_alteration_gst_value,
        name='get_alteration_gst_value'),
